...
namespace GherkinWebAPI.Core
{
    public interface IEmployeeRepository
    {
        ...
        Task<List<EmployeeWithDeptSkillsAndDesignation>> GetAllEmployeeByDeptCode(int orgOfficeNo, string deptId);
        Task<IEnumerable<object>> GetAllEmployeeByDesignationCodeCustomObject(string designationcode);
        Task<IList<Employee>> GetAllEmployeeByDesignationCode(string designationcode);
