...
namespace GherkinWebAPI.Core
{
    public interface IFarmerService
    {
        ...
        Task<FarmerDetailsDTO> GetFarmersByCode(string id);
        ...
        Task UpdateFarmer(string code, FarmerDetailsDTO farmer);
        Task SaveFarmerDocuments(IEnumerable<FarmerDocument> documents);
